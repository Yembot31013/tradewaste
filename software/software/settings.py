...
SECRET_KEY = 'django-insecure-osy^h%bf!o=5*ps8y9rn$h4jkm*naiws#w1ue!55r0#14278+n'
...
# EMAIL_HOST = ""
# EMAIL_PORT = ""
EMAIL_HOST_USER = "malwarefinder3@gmail.com"
EMAIL_HOST_PASSWORD = "3101331013"
EMAIL_USE_TLS = True
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "MC TradeWaste Admin",

    # "show_ui_builder": True,
    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "Mc TradeWaste",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "Mc TradeWaste",
    ...
    "login_logo": "logos.jpg",

    # Logo to use for login form in dark themes (defaults to login_logo)
    "login_logo_dark": "logos.jpg",
    ...
    "copyright": "Mc TradeWaste | Created by Yembot",
